...
**Software Engineer at Sabre Poland** | **Full Stack Developer**  
📍 Kraków, Poland  
...
- Hands-on experience with the entire software development lifecycle, from design to CI/CD and deployment
- Strong foundation in both front-end and back-end technologies

### 🚀 Ambitions
- Seeking to leverage full-stack skills in challenging product teams
...
*July 2023 – Present*
- Design and development of microservices - Implementation and maintenance of backend microservices, ensuring system scalability and flexibility
- Working with React technology - Creating and optimizing user interfaces using React, and integrating with backend microservices
- Programming in TypeScript - Developing applications using TypeScript, enhancing code safety and readability
- Styling with LESS - Using LESS to create and manage advanced style sheets
- Project management in Kanban methodology - Organization and prioritization of tasks using Kanban boards

### Computer Alliance, Kraków – Web Administrator
*June 2021 – August 2021*
- E-commerce platform management (Shopper)
- Shaping the application architecture

### WWP Capital, Kraków – Developer
*July 2019 – December 2019*
- Creating applications for the Android platform
- Participating in the application design process and advanced interfaces
- Active cooperation with other front-end and back-end departments
...
- **Mikroserwisy z Spring Cloud - tworzenie aplikacji webowych** – Udemy
- **Podstawy marketingu internetowego** – Google
- **TELC B2 Certificate** – SJO
- **AI jako twój partner w karierze** – Microsoft
...
![PageSpeed Insights](https://img.shields.io/badge/PageSpeed%20Insights-4285F4?style=for-the-badge&logo=google-pagespeed&logoColor=white)
...
### [Innovative Didactic Tool - 3D Simulations](https://michael21official.github.io/engines/)
Application combining advanced electromechanical phenomena simulations with interactive 3D visualizations using Three.js. Enables independent experimentation with machine parameters through an intuitive user interface.

**Technologies:** Three.js, WebGL, 3D, Simulations, React

### [Portfolio Website](https://portfolio.matsalak.pl/)
Personal portfolio built with React, TypeScript, MUI, and Vite. Features include dark/light mode, EmailJS integration, Google Analytics, and responsive design.
